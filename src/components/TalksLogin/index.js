...
const TalksLogin = (data) => {
  ...
  return (
    <div>
      ...
      <p>
        [akki@AkashNeeds ~]${" "}
        <span className={talksLoginStyles.typed}>
          &nbsp;history<span>&nbsp;</span>
        </span>
      </p>
      <div className={hidden ? talksLoginStyles.hiddenPart : ""}>
        ...
        <hr />
        <p>
          This is a list of the talks and podcast episodes I've been involved
          with. I'll do my best to provide links to slides, videos, and other
